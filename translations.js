/**
 * Wild Rose Jewel - Translations
 * Словарь для поддержки мультиязычности (RU, EN, KK).
 */
const WRJ_TRANSLATIONS = {
    ru: {
        nav_home: "Главная",
        nav_catalog: "Каталог",
        nav_lookbook: "Образы",
        ...
        season_summer: "Лето",
        season_autumn: "Осень",
        season_symbol: "Символы",
        filter_all: "Все",
        filter_necklaces: "Колье",
        filter_bracelets: "Браслеты",
        filter_earrings: "Серьги",
        filter_rings: "Кольца",
        filter_sets: "Комплекты",
        menu_title: "МЕНЮ",
        contact_us: "Свяжитесь с нами",
        whatsapp_message_intro: "Здравствуйте! Хочу оформить заказ из каталога Wild Rose Jewel:\n\n",
        ...
        cat_bracelets_tag: "Изящество на вашем запястье",
        cat_earrings_tag: "Легкость в каждой детали",
        cat_rings_tag: "Отражение вашего стиля",
    ...
    en: {
        ...
        btn_cart_added: "Remove from cart",
        ...
        whatsapp_message_intro: "Hello! I would like to place an order from Wild Rose Jewel:\n\n",
        whatsapp_message_total: "\nTotal: ",
        ...
        cat_bracelets_tag: "Elegance on your wrist",
        cat_earrings_tag: "Lightness in every detail",
        cat_rings_tag: "Reflecting your style",
    ...
    kk: {
        ...
        btn_cart_add: "Себетке",
        btn_cart_added: "Себеттен алып тастау",
        ...
        price_request: "Сұраныс бойынша",
        season_winter: "Қыс",
        season_spring: "Көктем",
        season_summer: "Жаз",
        season_autumn: "Күз",
        season_symbol: "Символдар",
        filter_all: "Барлығы",
        filter_necklaces: "Алқалар",
        filter_bracelets: "Білезіктер",
        filter_earrings: "Сырғалар",
        ...
        cat_bracelets_tag: "Білезігіңіздегі әсемдік",
        cat_earrings_tag: "Әрбір детальдағы жеңілдік",
        cat_rings_tag: "Стиліңіздің көрінісі",
