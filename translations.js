...
if (WRJ_TRANSLATIONS.ru) {
    Object.assign(WRJ_TRANSLATIONS.ru, {
        ...
        announcement_handcrafted: "100% Ручная авторская работа",
        announcement_gift: "Подарочная коробочка к каждому заказу",
        announcement_shipping: "Доставка по Казахстану и миру",
        filter_mineral_all: "Все камни",
        filter_mineral_pearl: "Жемчуг",
        filter_mineral_quartz: "Кварц & Лунный",
        filter_mineral_amethyst: "Аметист & Агат",
        filter_mineral_symbol: "Символы & Серии",
        quick_categories_title: "Популярные категории",
        quick_categories_subtitle: "Выберите то, что подчеркнет вашу индивидуальность прямо сейчас",
        size_guide_title: "Гайд по выбору размера",
        size_guide_subtitle: "Несколько простых шагов, чтобы украшение село идеально",
        care_guide_title: "Правила ухода и гарантия",
        care_guide_subtitle: "Как сохранить первозданный блеск и сияние ваших украшений"
    });
}
...
if (WRJ_TRANSLATIONS.en) {
    Object.assign(WRJ_TRANSLATIONS.en, {
        ...
        announcement_handcrafted: "100% Artisan Handcrafted",
        announcement_gift: "Complimentary Luxury Gift Box",
        announcement_shipping: "Worldwide & Express Shipping",
        filter_mineral_all: "All Stones",
        filter_mineral_pearl: "Pearls",
        filter_mineral_quartz: "Quartz & Moonstone",
        filter_mineral_amethyst: "Amethyst & Agate",
        filter_mineral_symbol: "Symbols & Series",
        quick_categories_title: "Popular Categories",
        quick_categories_subtitle: "Find the signature piece that speaks to your unique style",
        size_guide_title: "Size Selection Guide",
        size_guide_subtitle: "Simple steps to make sure your jewelry fits perfectly",
        care_guide_title: "Care Guide & Guarantee",
        care_guide_subtitle: "How to preserve the authentic sparkle of your jewelry",
